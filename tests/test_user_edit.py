...
# 3. Редактирование
# 4. Получение данных
@allure.epic("Кейсы на изменение")
class TestUserEdit(BaseCase):
    ...
    @allure.description(
        ...
        "3. Редактирование данного пользователя;"
        "4. Получение его данных;"
        "5. Проверка, что пользователь действительно отредактировался")
    ...
    @allure.title("Редактирование пользователя будучи неавторизованным")
    @allure.description(
        "В тесте:"
        "1. Создается пользователь;"
        "2. Редактирование данного пользователя;"
        "4. Получение его данных;"
        "5. Проверка, что пользователь действительно не отредатировался")
# Попытаемся изменить данные пользователя, будучи неавторизованными
    ...
    @allure.description(
        ...
        "3. Изменение второго пользователя по данным первого;"
        "4. Проверка, что оба пользователя не изменены")
    @allure.tag("Создание", "Авторизация", "Изменение")
...
# Второй пользователь
    ...
    @allure.title("Изменение email на новый email без @")
    @allure.description(
        "В тесте:"
        "1. Создается пользователь;"
        "2. Происходит авторизация из-под него;"
        "3. Изменение email на новый email без @;"
        "4. Получение его данных;")
    @allure.tag("Создание", "Авторизация", "Изменение")
...
# РЕГИСТРАЦИЯ
    ...
    @allure.title("Изменение firstName пользователя на очень короткое значение, будучи авторизованными тем же пользователем")
    @allure.description(
        "В тесте:"
        "1. Создается пользователь;"
        "2. Происходит авторизация из-под него;"
        "3. Изменение firstName пользователя на короткое значение в один символ;"
        "4. Получение его данных;"
        "5. Проверка, что появилась ошибка 'The value of 'firstName' field is too short'")
    @allure.tag("Создание", "Авторизация", "Изменение")
